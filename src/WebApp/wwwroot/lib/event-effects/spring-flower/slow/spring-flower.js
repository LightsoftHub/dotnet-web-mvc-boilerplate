//<![CDATA[
//var pictureSrc ="/lib/newyear/hoamai.png"; //the location of the snowflakes
const pictures = ["/lib/newyear/hoadao.png", "/lib/newyear/hoamai.png"]; //the location of the snowflakes
const random = Math.floor(Math.random() * pictures.length);
var pictureSrc = pictures[random]; //the location of the snowflakes
